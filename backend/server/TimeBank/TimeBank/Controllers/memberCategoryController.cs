...
namespace TimeBank.Controllers
{
    ...
    {//בפוסט שולחים רק משתנה אחד! בגט אפשר שתים בURL אבל אם אצ רוצה בפוסט-תצרי מערך
        ...
        public ActionResult<Dto.dtoClasses.CategoryMemberDto> addMemberCategory
        ...
        public ActionResult<List<Dto.dtoClasses.CatPlusMemberDto>> getAllMemberCategory()
        {
             List<Dto.dtoClasses.CatPlusMemberDto> catPlusMembers = Bll.functions.memberCategoryFunction.getAllCategoriesMember();
       ...
       // [HttpGet("getFilterMemberCategory")]
        ...
        public ActionResult<List<Dto.dtoClasses.CatPlusMemberDto>> getFilterMemberCategory(Dto.dtoClasses.CatPlusMemberDto filter)
        {
            List<Dto.dtoClasses.CatPlusMemberDto> catPlusMembers = Bll.functions.memberCategoryFunction.GetFilteredMemberCategories(filter);
            return Ok(catPlusMembers);
        }
    }
}
